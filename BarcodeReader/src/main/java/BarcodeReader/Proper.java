...
public class Proper extends Properties {
    ...
    public Proper() throws IOException {
        ...
        if(!Globals.configFile.exists())
        {
            ...
            sb.append("SCREENSHOT_BIND=64\nEXIT_BIND=65\nMAX_TIMES_RUNNED_APP=10");
            writer.write(sb.toString());
            writer.close();
        }
        inputStream = Files.newInputStream(Paths.get(Globals.ini_path_without_ini.getParent() + File.separator + "config.ini"));
    }
